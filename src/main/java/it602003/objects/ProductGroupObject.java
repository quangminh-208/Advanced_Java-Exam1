...
public class ProductGroupObject {
	private short pg_id;
	...
	public void setPg_enable(String pg_enable) {
		this.pg_enable = pg_enable;
	}
	...
	public String toString() {
		return "ProductGroupObject [pg_id=" + pg_id + ", pg_name=" + pg_name + ", pg_ps_id=" + pg_ps_id
				+ ", pg_manager_id=" + pg_manager_id + ", pg_notes=" + pg_notes + ", pg_delete=" + pg_delete
				+ ", pg_deleted_date=" + pg_deleted_date + ", pg_deleted_author=" + pg_deleted_author
				+ ", pg_modified_date=" + pg_modified_date + ", pg_created_date=" + pg_created_date + ", pg_enable="
				+ pg_enable + ", pg_name_en=" + pg_name_en + ", pg_created_author_id=" + pg_created_author_id
